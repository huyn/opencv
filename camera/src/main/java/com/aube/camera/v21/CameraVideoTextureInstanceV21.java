...
public class CameraVideoTextureInstanceV21 implements CameraInstance {
    ...
    public CameraVideoTextureInstanceV21(AutoFitTextureView textureView, Activity activity) {
    ...
    private void stopRecordingVideo() {
        ...
        // to resolve exception issue when stop recording.
        try {
